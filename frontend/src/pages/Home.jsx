    ...
    <div>
      <section className="relative w-full h-[20rem] mb-8 bg-[url('/header-bg.png')] bg-center bg-cover lg:mb-16 md:h-[25rem] lg:h-[40rem]">
        <div className="flex flex-col justify-between w-full h-full px-10 lg:px-20">
          <div className="my-auto space-y-16">
            <h2 className="text-white font-bold text-3xl/[1.3] sm:text-4xl/[1.3] md:text-5xl/[1.3] lg:text-7xl/[1.3]">
              Criamos união em <br />
          ...
          <div className="flex w-full items-center mb-8">
            ...
            <div className="flex-1 border-t-2 border-white mx-4"></div>
      ...
      <section className="flex flex-col lg:flex-row items-center justify-between px-10 py-12 sm:py-16 lg:px-20">
        <div className="lg:w-[55%]">
          <div className="flex items-center">
            <h3 className="text-md tracking-wider text-nowrap text-[#1FA4E4]">
          ...
          <p className="text-lg/[1.8] text-textc text-justify my-8">
          ...
          <p className="text-lg/[1.8] text-textc text-justify mb-16">
            Nossa missão é construir pontes de solidariedade, facilitando a
            comunicação entre vítimas e voluntários.
          </p>

          <a href="/sobre" className="bg-primary text-white font-bold py-4 px-10 rounded hover:bg-[#006BB1] transition duration-300">Saiba mais</a>
        </div>
        ...
        <div className="flex flex-col w-full">
          ...
          <div className="flex flex-col mt-8 gap-x-8 gap-y-6 xl:gap-x-16 lg:flex-row">
            <div className="w-full h-[260px] flex flex-col bg-blue-50 justify-center items-center p-8 rounded-lg border border-primary 
              ...
              <h4 className="text-xl font-bold my-6">Crie sua conta</h4>

              <p className="text-center text-md text-textc">
            ...
            <div className="w-full h-[260px] flex flex-col bg-blue-50 justify-center items-center p-8 rounded-lg border border-primary 
              ...
              <h4 className="text-xl text-center font-bold my-6">Publique seu pedido</h4>
            ...
            <div className="w-full h-[260px] flex flex-col bg-blue-50 justify-center items-center p-8 rounded-lg border border-primary 
              ...
              <h4 className="text-xl font-bold my-6">Receba ajuda</h4>
      ...
      <section className="flex flex-col lg:flex-row items-center justify-between mb-24 px-10 py-12 sm:py-16 lg:px-20">
        <div className="lg:w-[55%]">
          ...
          <p className="text-lg/[1.8] text-textc text-justify mt-8 mb-16">
          ...
          <a className="bg-primary text-white font-bold py-4 px-10 rounded hover:bg-[#006BB1] transition duration-300" href="/register">Ser voluntário</a>
        </div>
