    ...
    <footer className="bg-black text-white py-14 w-full px-10 lg:px-20">
        ...
        <div className="grid lg:grid-cols-[25%_40%_35%] md:grid-cols-[35%_65%]">
          <div className="text-center text-left">
            ...
            <div className='flex flex-col justify-between xs:flex-row md:flex-col'>
                <p className="text-md mb-4">nexus@gmail.com</p>
                <p className="text-md mb-4">55+ 17 99132-3055</p>
            </div>
          </div>
          ...
          <div className="hidden lg:block text-center lg:text-left mx-6">
            ...
            <ul className="grid grid-cols-[25%_25%_25%] gap-4">
              ...
              <li><a href="#contato" className="hover:text-[#FFF]">Perguntas</a></li>
            </ul>
          </div>

          <div className="text-left mb-4 mt-6 md:mt-0">
            <h3 className="text-2xl font-bold mb-6 text-white">Receber novidades</h3>

            <form action="#" method="POST" className="flex">
              <input type="email"
                className="text-nowrap text-white bg-black w-full rounded-l-md border-2 border-[#D4D4D4] ps-3"
      ...
      <div className="w-full mt-8 text-center">
        ...
        <div className="flex flex-col justify-between items-center mt-6 sm:flex-row">
          ...
          <p className="text-sm text-center text-gray-400 mt-6 sm:text-right sm:mt-0">© 2024 Nexus. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  )
